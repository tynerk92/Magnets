 ...
 <tileset firstgid="1" name="Tileset" tilewidth="800" tileheight="600" tilecount="664" columns="0">
  ...
  <tile id="536">
   <properties>
    ...
    <property name="~Idle Right" value="Player Idle Right"/>
    <property name="~Idle Left" value="Player Idle Left"/>
    <property name="~Idle Up" value="Player Idle Up"/>
    <property name="~Idle Down" value="Player Idle Down"/>
    <property name="~Walking Right" value="Player Walking Right"/>
    <property name="~Walking Left" value="Player Walking Left"/>
    <property name="~Walking Up" value="Player Walking Up"/>
    <property name="~Walking Down" value="Player Walking Down"/>
    <property name="~Pushing Right" value="Player Pushing Right"/>
    <property name="~Pushing Left" value="Player Pushing Left"/>
    <property name="~Pushing Up" value="Player Pushing Up"/>
    <property name="~Pushing Down" value="Player Pushing Down"/>
    <property name="~Pushing Right To Idle" value="Player Pushing Right To Idle"/>
    <property name="~Pushing Left To Idle" value="Player Pushing Left To Idle"/>
    <property name="~Pushing Up To Idle" value="Player Pushing Up To Idle"/>
    <property name="~Pushing Down To Idle" value="Player Pushing Down To Idle"/>
    <property name="~Idle To Pushing Right" value="Player Pushing Right To Idle"/>
    <property name="~Idle To Pushing Left" value="Player Pushing Left To Idle"/>
    <property name="~Idle To Pushing Up" value="Player Pushing Up To Idle"/>
    <property name="~Idle To Pushing Down" value="Player Pushing Down To Idle"/>
