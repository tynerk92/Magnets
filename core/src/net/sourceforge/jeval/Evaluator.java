...
public class Evaluator {
	 ...
	 * @param loadMathVariables      Indicates if the standard Math variables should be loaded or
	 *                               not.
	 * @param loadMathFunctions      Indicates if the standard Math functions should be loaded or
	 *                               not.
	 * @param loadStringFunctions    Indicates if the standard String functions should be loaded or
	 *                               not.
	 * @param processNestedFunctions Indicates if nested function calls should be processed or not.
	 * @throws IllegalArgumentException Thrown when the quote character is not a valid quote
	 *                                  character.
	 */
	 ...
	 *
	 * @param quoteCharacter The quote character to use when evaluating expressions.
	 * @throws IllegalArgumentException Thrown when the quote character is not a valid quote
	 *                                  character.
	 */
	 ...
	 * @throws IllegalArgumentException Thrown when the function name is not valid or the function
	 ...
	 *
	 * @param functionName The name of the function to retrieve the value for.
	 ...
	 * @param variableValue The value for the variable being set.
	 */
	 ...
	 * @throws Throws an EvaluatorException if the variable name can not be
	 *                resolved.
	 */
	 ...
	 * place.
	 * @throws EvaluateException Thrown when an error is found while evaluating the
	 *                           expression.
	 */
	 ...
	 *
	 * @param expression                The expression to evaluate.
	 * @param keepQuotes                Indicates if the the quotes should be kept in the result or
	 *                                  not. This is only for string expression that are enclosed in
	 *                                  quotes prior to being evaluated.
	 * @param wrapStringFunctionResults Indicates if the results from functions that return strings
	 ...
	 * @param operatorIndex The position in the expression where the current operator
	 *                      being processed is located.
	 * @param operandStack  The stack of operands.
	 * @param unaryOperator The unary operator if we are working with one.
	 * @return The new position in the expression where processing should
	 * continue.
	 * @throws EvaluateException Thrown is an error is encoutnered while processing the
	 *                           expression.
	 */
	 ...
	 * @param operandStack  The stack of operands.
	 * @param haveOperand   Indicates if have an operand to process.
	 * @param unaryOperator The unary operand associated with thi operator. This may be
	 *                      null.
	 * @return The new position in the expression where processing should
	 * continue.
	 * @throws EvaluateException Thrown is an error is encoutnered while processing the
	 ...
	 * @param unaryOperator The unary operator associated with this function. This can be
	 *                      null.
	 ...
	 *
	 * @param expression The expression being evaluated.
	 * @param start      The position in the expression to start searching for the next
	 *                   operator.
	 * @param match      The operator to search for. This can be null if you want the
	 ...
	 * <ul>
	 *
	 * @param name The function or variable name being validated.
