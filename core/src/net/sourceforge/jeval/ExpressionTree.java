...
public class ExpressionTree {
	 ...
	 *
	 * @param evaluator     The Evaluator object processing this tree.
	 * @param leftOperand   The left operand to place as the left node of the tree.
	 * @param rightOperand  The right operand to place as the right node of the tree.
	 * @param operator      The operator to place as the operator node of the tree.
	 * @param unaryOperator The new unary operator for this tree.
	 */
	 ...
	 * @throws EvaluateException Thrown is an error is encountered while processing the
	 *                           expression.
	 */
