...
public class EvaluationResult {
	 ...
	 * Constructor.
	 *
	 * @param result         The value returned from the evaluation of an expression.
	 * @param quoteCharacter The quote character specified in the evaluation of the
	 *                       expression.
	 */
	 ...
	 * @throws NumberFormatException Thrown if the result value is not a double.
	 */
