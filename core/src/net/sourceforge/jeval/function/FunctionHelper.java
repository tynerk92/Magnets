...
public class FunctionHelper {
	 ...
	 * be thrown.
	 *
	 * @param arguments      The arguments to trim and revove quote characters from.
	 * @param quoteCharacter The character to remove from the first and last position of
	 *                       the trimmed string.
	 * @return The arguments with white space and quote characters removed.
	 * @throws FunctionException Thrown if quote characters do not exist in the first and
	 ...
	 * @param delimiter The delimiter to use while parsing.
	 * @return An array list of Double values found in the input string.
	 * @throws FunctionException Thrown if the string does not properly parse into Double
	 *                           values.
	 */
	 ...
	 * the evaluations.
	 *
	 * @param arguments The arguments of values to parse.
	 * @param delimiter The delimiter to use while parsing.
	 * @return An array list of String values found in the input string.
	 * @throws FunctionException Thrown if the stirng does not properly parse into String
	 *                           values.
	 */
	 ...
	 * @throws FunctionException Thrown if the stirng does not properly parse into the
	 *                           proper objects.
	 */
